...
import com.bumptech.glide.Glide;
import com.bumptech.glide.load.engine.DiskCacheStrategy;
import com.example.pluralsight.LearningLeaders;
...
class LearningAdapter extends RecyclerView.Adapter<LearningAdapter.LearningViewHolder> {
    ...
    //Member variables
    private ArrayList<LearningLeaders> mLearnerList;
    private Context mContext;

    LearningAdapter(Context context, ArrayList<LearningLeaders> learnerData) {
    ...
    public void onBindViewHolder(LearningViewHolder  holder, int position) {
        ...
        LearningLeaders currentLearner = mLearnerList.get(position);
    ...
    static class LearningViewHolder extends RecyclerView.ViewHolder{
        ...
        void bindTo(LearningLeaders currentLearner) {
